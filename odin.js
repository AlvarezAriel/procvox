...
loadF32Array(addr, len) { return new Float32Array(this.memory.buffer, addr >>> 0, len); }
loadF64Array(addr, len) { return new Float64Array(this.memory.buffer, addr >>> 0, len); }
loadU32Array(addr, len) { return new Uint32Array(this.memory.buffer, addr >>> 0, len); }
loadI32Array(addr, len) { return new Int32Array(this.memory.buffer, addr >>> 0, len); }
loadU16Array(addr, len) { return new Uint16Array(this.memory.buffer, addr >>> 0, len); }
loadI16Array(addr, len) { return new Int16Array(this.memory.buffer, addr >>> 0, len); }
loadU8Array(addr, len) { return new Uint8Array(this.memory.buffer, addr >>> 0, len); }
loadI8Array(addr, len) { return new Int8Array(this.memory.buffer, addr >>> 0, len); }
...
loadBytes(ptr, len) {
return new Uint8Array(this.memory.buffer, ptr >>> 0, Number(len));
}
loadString(ptr, len) {
len = Number(len);
if (len === 0) { return ""; }
(this._textDecoder ??= new TextDecoder());
let bytes = this.loadBytes(ptr, len);
...
if (res instanceof Uint32Array) { this.mem.loadU32Array(params_ptr, res.length).set(res)
} else {
